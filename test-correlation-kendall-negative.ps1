...
.DESCRIPTION
    Posts FHIR data for neighbourhood samples I01-I20 in neighborhood N81, then validates
    ...
    Data design (ordinal grouped, tie-rich - INVERSE directions):
      ...
      Tied values within each 4-neighbourhood-sample tier exercise Kendall tau-B
...
# ==========================================================================
# DATA - 20 neighbourhood samples in 5 ordinal tiers of 4 neighbourhood samples each - INVERSE directions
...
Write-Host "  $CoefficientName Test - INVERSE Directions (${City})" -ForegroundColor DarkYellow
Write-Host "================================================================" -ForegroundColor DarkYellow
Write-Host ""
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor DarkYellow
Write-Host "  NEIGHBOURHOOD SOURCE DATA" -ForegroundColor DarkYellow
Write-Host "================================================================" -ForegroundColor DarkYellow
Write-Host ""
if ($corr.neighRows) {
