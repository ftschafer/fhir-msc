...
.DESCRIPTION
    Posts FHIR data for blocks G01-G20 in neighborhood N81, then validates
...
# ==========================================================================
# DATA - 20 blocks, INVERSE direction pattern, non-linear monotonic
...
Write-Host "  $CoefficientName Test - INVERSE Directions ($Neighborhood)" -ForegroundColor DarkGreen
Write-Host "================================================================" -ForegroundColor DarkGreen
Write-Host ""
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor DarkGreen
Write-Host "  BLOCK DATA" -ForegroundColor DarkGreen
Write-Host "================================================================" -ForegroundColor DarkGreen
Write-Host ""
if ($corr.blockRows) {
