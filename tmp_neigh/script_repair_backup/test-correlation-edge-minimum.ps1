<#
.SYNOPSIS
    Edge-case test: MINIMUM 3 neighbourhood samples (boundary condition).
...
.DESCRIPTION
    ...
    near â”¬â–’1 despite the tiny sample size.
...
if ($fail -eq 0) {
    ...
    Write-Host "  ALL MINIMUM-SAMPLE TESTS PASSED" -ForegroundColor Green
} else {
