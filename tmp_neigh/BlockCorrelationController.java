...
public class BlockCorrelationController {
    ...
    // ÔöÇÔöÇ Moran's I ÔÇö Spatial Autocorrelation ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    private Map<String, Object> moranResult(
        ...
        if (ss == 0.0) {
            ...
            out.put("interpretation", "All blocks have the same value ÔÇö no spatial pattern to detect");
            return out;
        }
        ...
        if (pValue < 0.05 && observedI > expectedI) {
            pattern = "clustered";
            interpretation = "Significant positive spatial autocorrelation ÔÇö similar values cluster together. Block-level intervention is justified.";
        } else if (pValue < 0.05 && observedI < expectedI) {
            pattern = "dispersed";
            interpretation = "Significant negative spatial autocorrelation ÔÇö neighbouring blocks tend to have dissimilar values.";
        } else {
            pattern = "random";
            interpretation = "No significant spatial pattern detected ÔÇö values appear spatially random across blocks.";
        }
     ...
     * <pre>
     *   I = (n / W) * ╬úßÁó ╬úÔ▒╝ wßÁóÔ▒╝ (xßÁó - x╠ä)(xÔ▒╝ - x╠ä)  /  ╬úßÁó (xßÁó - x╠ä)┬▓
     * </pre>
     * where W = ╬úßÁó ╬úÔ▒╝ wßÁóÔ▒╝.
     */
    ...
    // ÔöÇÔöÇ Analytical p-values ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇ Regularized incomplete beta function (for t-distribution CDF) ÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇ Permutation test ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇ Core correlation coefficients ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
