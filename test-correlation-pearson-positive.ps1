...
.DESCRIPTION
    Posts FHIR data for neighbourhood samples D01-D20 in neighborhood N81, then validates
...
# ==========================================================================
# DATA - 20 neighbourhood samples, original direction pattern
# ==========================================================================
$neighborhoodSamples = @(
...
Write-Host "  $CoefficientName Test - ORIGINAL Directions (${City})" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
