...
.SYNOPSIS
    ...
    Creates 5 blocks where one variable is constant across all blocks.

.DESCRIPTION
    Posts FHIR data for 5 blocks (L01-L05) in neighborhood N93.
    All blocks have identical heartRate (75), identical systolicBP (120),
...
# 5 blocks: vital signs are constant (zero variance)
$blocks = @(
...
Write-Host "  EDGE CASE: Zero Variance ($Neighborhood)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
# ==========================================================================
Write-Host ""
Write-Host "[2] Creating MeasureReports (5 blocks) ..."
$mrEntries = @()
foreach ($b in $blocks) {
    $mrEntries += @{
        resource = @{
...
# ==========================================================================
# STEP 6 - Vital Signs (all identical across blocks)
# ==========================================================================
Write-Host ""
...
# blockCount = 5
Write-Host "  blockCount = 5 ... " -NoNewline
if ($corr.blockCount -eq 5) {
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host "  SUMMARY - Zero Variance Edge Case" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Resources: 5 MeasureReports, 10 Patients (+1 anchor), $totalCond Conditions, 5 NEWS2, 15 Vitals"
Write-Host "  Design: HR=75, SBP=120, DBP=80 (constant across all 5 blocks)"
Write-Host ""
if ($fail -eq 0) {
    Write-Host "  PASS: $pass / $($pass + $fail)" -ForegroundColor Green
    Write-Host "  ALL ZERO-VARIANCE TESTS PASSED" -ForegroundColor Green
} else {
