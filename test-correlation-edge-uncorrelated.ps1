...
.SYNOPSIS
    ...
    Creates 15 blocks with deliberately randomized relationships.

.DESCRIPTION
    Posts FHIR data for 15 blocks (P01-P15) in neighborhood N95.
...
# 15 blocks with deliberately uncorrelated relationships
...
Write-Host "  EDGE CASE: Uncorrelated / Random Data ($Neighborhood)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
# ==========================================================================
Write-Host ""
Write-Host "[2] Creating MeasureReports (15 blocks) ..."
$mrEntries = @()
foreach ($b in $blocks) {
    $mrEntries += @{
        resource = @{
...
# blockCount = 15
Write-Host "  blockCount = 15 ... " -NoNewline
if ($corr.blockCount -eq 15) {
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host "  SUMMARY - Uncorrelated Data Edge Case" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Resources: 15 MeasureReports, 30 Patients (+1 anchor), $totalCond Conditions, 15 NEWS2, 45 Vitals"
Write-Host "  Design: Deliberately scrambled relationships - no systematic pattern"
Write-Host ""
if ($fail -eq 0) {
    Write-Host "  PASS: $pass / $($pass + $fail)" -ForegroundColor Green
    Write-Host "  ALL UNCORRELATED-DATA TESTS PASSED" -ForegroundColor Green
} else {
