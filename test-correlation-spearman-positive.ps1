...
.SYNOPSIS
    ...
    Creates 20 blocks and validates Spearman rank correlation coefficient.

.DESCRIPTION
    Posts FHIR data for blocks F01-F20 in neighborhood N81, then validates
...
# ==========================================================================
# DATA - 20 blocks, non-linear monotonic (geometric income, logistic news2,
...
Write-Host "  $CoefficientName Test - ORIGINAL Directions ($Neighborhood)" -ForegroundColor Green
Write-Host "================================================================" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Green
Write-Host "  BLOCK DATA" -ForegroundColor Green
Write-Host "================================================================" -ForegroundColor Green
Write-Host ""
if ($corr.blockRows) {
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Green
Write-Host "  SUMMARY - $CoefficientName, Original Directions" -ForegroundColor Green
Write-Host "================================================================" -ForegroundColor Green
Write-Host ""
