...
.DESCRIPTION
    Posts FHIR data for blocks H01-H20 in neighborhood N81, then validates
    ...
    Data design (ordinal grouped, tie-rich - optimal for Kendall tau-B):
      5 groups of 4 blocks each with clear between-group gaps and
...
# ==========================================================================
# DATA - 20 blocks in 5 ordinal tiers of 4 blocks each
# Tie structure: care/cond repeat within each 4-block tier, giving Kendall
...
Write-Host "  $CoefficientName Test - ORIGINAL Directions ($Neighborhood)" -ForegroundColor Yellow
Write-Host "================================================================" -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Yellow
Write-Host "  BLOCK DATA" -ForegroundColor Yellow
Write-Host "================================================================" -ForegroundColor Yellow
Write-Host ""
if ($corr.blockRows) {
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Yellow
Write-Host "  SUMMARY - $CoefficientName, Original Directions" -ForegroundColor Yellow
Write-Host "================================================================" -ForegroundColor Yellow
Write-Host ""
