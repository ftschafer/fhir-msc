<#
.SYNOPSIS
    Integration test for BlockCorrelationController - INVERSE correlations.
    Creates 20 blocks of FHIR data with OPPOSITE correlations to test-correlation-data.ps1.

.DESCRIPTION
        Posts MeasureReports, Patients, Conditions, Observations (NEWS2 + vital signs)
        for blocks C01-C20 in neighborhood N81, then calls:
            GET /analytics/block-correlations?neighborhood=N81
            GET /analytics/spatial-autocorrelation?neighborhood=N81
    ...
    The original test (test-correlation-data.ps1) also uses neighborhood N81 / blocks B01-B20.
#>
...
# ==========================================================================
# DATA DESIGN - 20 blocks with INVERSE correlation structure
# ==========================================================================
#
...
Write-Host "  FHIR INVERSE Correlation Test - 20 Blocks (N81)" -ForegroundColor Magenta
...
# ==========================================================================
Write-Host ""
Write-Host "[8] Calling GET /analytics/block-correlations?neighborhood=$Neighborhood ..."
try {
...
# ==========================================================================
Write-Host ""
Write-Host "[9] Calling GET /analytics/spatial-autocorrelation?neighborhood=$Neighborhood ..."
$moran = $null
try {
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Magenta
Write-Host "  BLOCK-LEVEL DATA (from server) - N81" -ForegroundColor Magenta
Write-Host "================================================================" -ForegroundColor Magenta
Write-Host ""
...
Write-Host "================================================================" -ForegroundColor Magenta
Write-Host ""
Write-Host "  Resources created (neighborhood $Neighborhood):"
