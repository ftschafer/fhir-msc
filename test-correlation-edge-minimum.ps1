<#
.SYNOPSIS
    Edge-case test: MINIMUM 3 BLOCKS (boundary condition).
    Creates exactly 3 blocks and validates correlation is still computed.

.DESCRIPTION
    Posts FHIR data for 3 blocks (K01-K03) in neighborhood N92, then validates
    that the controller:
      - Returns blockCount = 3
    ...
    The 3 blocks have a clear linear pattern so coefficients should be
...
# Exactly 3 blocks - the minimum for correlation
$blocks = @(
...
Write-Host "  EDGE CASE: Minimum 3 Blocks ($Neighborhood)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
# ==========================================================================
# STEP 2 - MeasureReports (3 blocks)
# ==========================================================================
Write-Host ""
Write-Host "[2] Creating MeasureReports (3 blocks) ..."
$mrEntries = @()
foreach ($b in $blocks) {
    $mrEntries += @{
        resource = @{
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host "  VALIDATION: Minimum 3 Blocks - Correlation Computed" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
# blockCount = 3
Write-Host "  blockCount = 3 ... " -NoNewline
if ($corr.blockCount -eq 3) {
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host "  MORAN'S I - 3 Blocks (minimum)" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($moran -and $moran.variables) {
    foreach ($v in $moran.variables) {
        ...
        if ($v.status -eq "ok") {
            ...
            Write-Host "PASS (zero_variance - acceptable for 3 blocks)" -ForegroundColor Yellow
            $pass++
        } else {
...
Write-Host ""
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host "  SUMMARY - Minimum 3 Blocks Edge Case" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
if ($fail -eq 0) {
    ...
    Write-Host "  ALL MINIMUM-BLOCKS TESTS PASSED" -ForegroundColor Green
} else {
