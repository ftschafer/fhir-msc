...
Write-Host "  EDGE CASE: Empty Neighborhood (${City})" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
# ==========================================================================
# STEP 1 - Neighbourhood correlations for empty neighborhood
# ==========================================================================
Write-Host ""
Write-Host "[1] GET /analytics/neigh-correlations ..."
try {
...
if ($corr.city -eq ${City}) {
    ...
    Write-Host "FAIL (expected '$Neighborhood', got '$($corr.city)')" -ForegroundColor Red
    $fail++
}
...
# ==========================================================================
Write-Host ""
Write-Host "[2] GET /analytics/neigh-spatial-autocorrelation ..."
try {
